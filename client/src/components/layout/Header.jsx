...
// const Header = () => {
//   // Get roleId from localStorage (or sessionStorage)
//   const roleId = localStorage.getItem('roleId');  // Ensure key name matches
...
//         <button className="flex items-center space-x-2 hover:text-gray-200">
//           <UserCircle size={24} />
//           <Link to="index" className="hover:text-gray-300">โปรไฟล์</Link>
//         </button>
//       </div>
...
//           {/* Menu accessible by different roles */}
