...
const ManageAssetTypes = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-4 bg-white rounded-lg shadow-lg"> 
      <h2 className="text-3xl font-bold text-gray-700 mb-6">ประเภทสินทรัพย์</h2>
      <button
      ...
      <table className="w-full mt-4 bg-white shadow-md rounded-lg overflow-hidden">
        <thead className="bg-gray-200 text-gray-700">
          <tr>
            <th className="py-3 px-4 text-left">ประเภทสินทรัพย์</th>
        ...
        <tbody>
          {data.map((item) => (
            <tr key={item.id} className="border-t border-gray-300">
              <td className="py-3 px-4">{item.typeasset_name}</td>
