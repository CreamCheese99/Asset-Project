...
// // API สำหรับส่งข้อมูล assetStatuses
// app.get('/api/getAssetStatuses', (req, res) => {
//   const assetStatuses = [
//     { status: "ใช้งาน", count: 100 },
//     { status: "ส่งซ่อม", count: 50 },
//     { status: "ชำรุด", count: 30 },
//     { status: "บริจาค/โอน", count: 10 },
//     { status: "รับโอน", count: 5 },
//     { status: "จำหน่าย", count: 2 }
//   ];
